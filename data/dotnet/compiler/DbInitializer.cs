...
namespace EmpireCompiler
{
            ...
            if (!context.GruntTasks.Any())
            {
                var GruntTasks = new List<GruntTask>
                {
                    new GruntTask
                    {
                        ...
                        Code = File.ReadAllText(Path.Combine(Common.CovenantTaskCSharpDirectory, "Launcher" + ".task")),
                    ...
                    new GruntTask
                    {
                        ...
                        AlternateNames = new List<string>(),
                        Description = "Stager.",
                        Code = File.ReadAllText(Path.Combine(Common.CovenantTaskCSharpDirectory, "Stager" + ".task")),
                        Options = new List<GruntTaskOption>(),
                    },
                    new GruntTask
                    {
                        ...
                        AlternateNames = new List<string>(),
                        Description = "Agent.",
                        Code = File.ReadAllText(Path.Combine(Common.CovenantTaskCSharpDirectory, "Agent" + ".task")),
                        Options = new List<GruntTaskOption>(),
                    },
                    new GruntTask
                    {
                    ...
                    new GruntTask
                    {
                        ...
                        Code = "",
                        TaskingType = GruntTask.GruntTaskingType.SetOption,
                        Options = new List<GruntTaskOption>
                        {
                            new GruntTaskOption
                            {
                    ...
                    new GruntTask
                    {
                        ...
                        Code = "",
                        TaskingType = GruntTask.GruntTaskingType.Jobs,
                        Options = new List<GruntTaskOption>()
                    },
                    new GruntTask
                    {
                        ...
                        Code = "",
                        TaskingType = GruntTask.GruntTaskingType.Kill,
                        Options = new List<GruntTaskOption>()
                    },
                    new GruntTask
                    {
                        ...
                        Code = "",
                        TaskingType = GruntTask.GruntTaskingType.Connect,
                        Options = new List<GruntTaskOption>
                        {
                            new GruntTaskOption
                            {
                    ...
                    new GruntTask
                    {
                        ...
                        Code = "",
                        TaskingType = GruntTask.GruntTaskingType.Disconnect,
                        Options = new List<GruntTaskOption>
                        {
                            new GruntTaskOption
                            {
    ...
    new GruntTaskReferenceSourceLibrary { ReferenceSourceLibrary = ss, GruntTask = await context.GetGruntTaskByName("PersistWMI") }
                ...
                var agent = await context.GetGruntTaskByName("Agent");
    ...
    new GruntTaskReferenceAssembly { GruntTask = launcher, ReferenceAssembly = await context.GetReferenceAssemblyByName("mscorlib.dll", Common.DotNetVersion.Net40) },
    new GruntTaskReferenceAssembly { GruntTask = launcher, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.dll", Common.DotNetVersion.Net35) },
    new GruntTaskReferenceAssembly { GruntTask = launcher, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.dll", Common.DotNetVersion.Net40) },
    new GruntTaskReferenceAssembly { GruntTask = launcher, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.Core.dll", Common.DotNetVersion.Net35) },
    new GruntTaskReferenceAssembly { GruntTask = launcher, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.Core.dll", Common.DotNetVersion.Net40) },

    new GruntTaskReferenceAssembly { GruntTask = stager, ReferenceAssembly = await context.GetReferenceAssemblyByName("mscorlib.dll", Common.DotNetVersion.Net35) },
    new GruntTaskReferenceAssembly { GruntTask = stager, ReferenceAssembly = await context.GetReferenceAssemblyByName("mscorlib.dll", Common.DotNetVersion.Net40) },
    new GruntTaskReferenceAssembly { GruntTask = stager, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.dll", Common.DotNetVersion.Net35) },
    new GruntTaskReferenceAssembly { GruntTask = stager, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.dll", Common.DotNetVersion.Net40) },
    new GruntTaskReferenceAssembly { GruntTask = stager, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.Core.dll", Common.DotNetVersion.Net35) },
    new GruntTaskReferenceAssembly { GruntTask = stager, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.Core.dll", Common.DotNetVersion.Net40) },
    
    new GruntTaskReferenceAssembly { GruntTask = agent, ReferenceAssembly = await context.GetReferenceAssemblyByName("mscorlib.dll", Common.DotNetVersion.Net35) },
    new GruntTaskReferenceAssembly { GruntTask = agent, ReferenceAssembly = await context.GetReferenceAssemblyByName("mscorlib.dll", Common.DotNetVersion.Net40) },
    new GruntTaskReferenceAssembly { GruntTask = agent, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.dll", Common.DotNetVersion.Net35) },
    new GruntTaskReferenceAssembly { GruntTask = agent, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.dll", Common.DotNetVersion.Net40) },
    new GruntTaskReferenceAssembly { GruntTask = agent, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.Core.dll", Common.DotNetVersion.Net35) },
    new GruntTaskReferenceAssembly { GruntTask = agent, ReferenceAssembly = await context.GetReferenceAssemblyByName("System.Core.dll", Common.DotNetVersion.Net40) },
