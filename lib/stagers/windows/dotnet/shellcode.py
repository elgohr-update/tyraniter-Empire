    ...
    def generate(self):
        ...
        if not self.mainMenu.listeners.is_listener_valid(listenerName):
            ...
            if launcher == "":
                ...
                command = self.mainMenu.installPath+'data/misc/donut/donut -a 1 '+ self.mainMenu.installPath+'/data/compiler/dotnet/data/Compiled/net35/Launcher.exe' +' -c Launcher -m Main'
                status,output = commands.getstatusoutput(command)
                if status == 0:
                    with open(self.mainMenu.installPath+'data/misc/donut/loader.bin','rb') as f:
                        return f.read()
                else:
                    return "" 
