...
class Module:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            ...
            'Description': ('GetNetLocalGroupMember'),
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        group_name=self.options['GroupName']['Value']
        return base64.b64encode(assembly)+','+base64.b64encode(computer_names)+','+base64.b64encode(group_name)
