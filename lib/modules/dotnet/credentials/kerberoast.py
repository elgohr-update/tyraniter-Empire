...
class Module:
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        usernames=self.options['Usernames']['Value']
        hash_format=self.options['HashFormat']['Value']
        return base64.b64encode(assembly)+','+base64.b64encode(usernames)+','+base64.b64encode(hash_format)
