...
class Module:
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        parameters=self.options['Parameters']['Value']
        directory=self.options['Directory']['Value']
        process_id=self.options['ProcessID']['Value']
        return base64.b64encode(assembly)+','+base64.b64encode(command)+','+base64.b64encode(parameters)+','+base64.b64encode(directory)+','+base64.b64encode(process_id)
