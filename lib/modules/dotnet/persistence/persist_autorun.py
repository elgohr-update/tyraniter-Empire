...
class Module:
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        target_hive=self.options['TargetHive']['Value']
        name=self.options['Name']['Value']
        value=self.options['Value']['Value']
        return base64.b64encode(assembly)+','+base64.b64encode(target_hive)+','+base64.b64encode(name)+','+base64.b64encode(value)
