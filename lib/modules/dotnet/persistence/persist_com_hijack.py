...
class Module:
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        clsid=self.options['CLSID']['Value']
        executable_path=self.options['ExecutablePath']['Value']
        return base64.b64encode(assembly)+','+base64.b64encode(clsid)+','+base64.b64encode(executable_path)
